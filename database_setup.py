...
def create_table(db_name='plant_care.db'):
    """Creates the 'plants' table in the specified database if it doesn't already exist."""
    conn = None
    try:
        ...
        # print(f"Database '{db_name}' and table 'plants' checked/created successfully.")
...
if __name__ == "__main__":
    ...
    print("Default database 'plant_care.db' and table 'plants' checked/created successfully.")

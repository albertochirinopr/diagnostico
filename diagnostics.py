KNOWLEDGE_BASE = [
    {
        ...
        'diagnosis': (
            "Potential nutrient deficiency (e.g., nitrogen, iron) or "
            "overwatering."
        ),
        'treatment': (
            "Check soil moisture. If soggy, allow to dry. If dry, "
            "consider a balanced fertilizer according to plant needs. "
    ...
    },
    {
        ...
        'diagnosis': (
            "Potential low humidity, underwatering, or salt buildup."
        ),
        'treatment': (
            "Increase humidity around the plant (misting, humidifier). "
            "Ensure consistent watering. Flush soil with distilled water "
    ...
    },
    {
        ...
        'treatment': (
            "Improve air circulation. Reduce humidity if very high. "
            "Remove affected leaves. Apply a fungicide if necessary. "
    ...
    },
    {
        ...
        'diagnosis': (
            "Could be underwatering or overwatering, or root rot."
        ),
        'treatment': (
            "Check soil moisture. If dry, water thoroughly. If wet, "
            "allow soil to dry out and check roots for rot (mushy, brown). "
            "Repot if root rot is present."
        )
    },
    {
        'keywords': [
            "pests", "insects", "aphids", "spider mites", "mealybugs", "gnats"
        ],
        'diagnosis': "Pest infestation.",
        'treatment': (
            "Identify the pest. Isolate the plant. Treat with appropriate "
            "insecticidal soap, neem oil, or manual removal "
            "(e.g., wiping with alcohol for mealybugs)."
        )
    },
    {
        ...
        'treatment': (
            "Ensure the plant is receiving adequate light for its species. "
            "Fertilize if not done recently. Check if the plant needs "
    ...
    },
    {
        ...
        'treatment': (
            ...
            "Avoid overhead watering. Apply fungicide/bactericide if severe."
        )
    }
]
...
def diagnose_plant_symptoms(symptoms_text: str) -> list[dict]:
    ...
    # To avoid duplicate diagnosis entries if multiple keywords trigger it
    matched_diagnoses = set()

    for rule in KNOWLEDGE_BASE:
        for keyword in rule['keywords']:
            if keyword.lower() in symptoms_text_lower:
                # Use the diagnosis itself as the key for the set
                ...
                break  # Move to the next rule once a keyword matches
    return results
...
if __name__ == "__main__":
    ...
    # Example 1
    symptoms_text_example1 = (
        "My fern has yellow leaves and some brown tips. "
        "I also saw some white spots that look powdery."
    )
    ...
    if diagnoses1:
        print(
            ...
            "here are potential issues and treatments:"
        )
        ...
        print(
            "No specific diagnosis found based on the provided symptoms. "
            "Check general plant care."
        )

    # Example 2: Different symptoms
    symptoms_text_example2 = (
        "The leaves on my succulent are wilting and it seems to have "
        "stunted growth. I also saw some tiny spider mites webbings."
    )
    ...
    symptoms_text_example3 = (
        "My plant looks generally okay, but I am worried."
    )
    ...
    if diagnoses3:
        ...
        print(
            "\nNo specific diagnosis found for these symptoms. "
